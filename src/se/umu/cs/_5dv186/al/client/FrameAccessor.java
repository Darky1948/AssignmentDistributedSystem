...
public interface FrameAccessor {
	...
	public interface Frame {
		// ----------------------------------------------------------
		public Block getBlock(int blockX, int blockY) throws IOException,
				SocketTimeoutException;
	}
	...
	public interface Factory {
		// ----------------------------------------------------------
		public FrameAccessor getFrameAccessor(StreamServiceClient client,
				String stream);

		// ----------------------------------------------------------
		public FrameAccessor getFrameAccessor(StreamServiceClient[] clients,
				String stream);
	}
}
